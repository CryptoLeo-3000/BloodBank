...
<div class="row">
    ...
    <div class="col-md-4 text-center">
        <h3 style="color: #fff;font-size: 2rem;">Navigation Links</h3>
        <a style="font-size: 2rem; color: #ccc; display: block;" href="index.php">Home</a>
        <a style="font-size: 2rem; color: #ccc; display: block;" href="become-donar.php">Become a Donor</a>
        <a style="font-size: 2rem; color: #ccc; display: block;" href="search-donor.php">Search Blood</a>
        <a style="font-size: 2rem; color: #ccc; display: block;" href="contact.php">Contact Us</a>
    </div>
